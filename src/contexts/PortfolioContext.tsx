...
const mockExperiences: Experience[] = [
  ...
  },
  {
    ...
    description: "I develop responsive business applications focused on performance and user experience. I contributed to the development of a legal platform for finding lawyers and management systems used by stores and businesses to manage sales, inventory, and finances. I’ve also built custom landing pages for companies and professionals.",
    descriptionPt: 'Desenvolvo aplicações empresariais responsivas com foco em performance e experiência do usuário. Contribuí para o desenvolvimento de uma plataforma jurídica voltada à busca de advogados e de sistemas de gestão usados por lojas e empresas para controle de vendas, estoque e finanças. Também desenvolvi landing pages personalizadas para empresas e profissionais.',
